...
//        HttpManger.getHttpMangerInstance().getServices().enterpriseLogin(body).enqueue(new Callback<LoginResponseBean>() {
//            @Override
...
//                    if (bring != null) {
//
//                        parseLoginBring(loginBean, bring);
//
//                    }
//
//                }
...
//                LoginResponseBean.BringBean bring = response.body().getBring();
...
//                        String carType = bring.getCarType();
////0
//                        if (TextUtils.isEmpty(carType)) {
//                            startActivity(new Intent(UIUtils.getContext(), MainActivity.class));
//                        } else {
//                            if (carType.equals(CAR_TYPE_JIAYOUCHE)) {
//                                startActivity(new Intent(UIUtils.getContext(), MainActivity.class));
//                            } else if (carType.equals(CAR_TYPE_BUJICHE)) {
////   1
...
////                    Log.i(TAG, "onResponse: =用户信息=>"+userInfo);
