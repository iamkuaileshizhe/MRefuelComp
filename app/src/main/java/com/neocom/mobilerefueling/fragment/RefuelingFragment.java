...
import com.neocom.mobilerefueling.activity.OrderSuccessActivity;
import com.neocom.mobilerefueling.activity.TicketActivity;
...
public class RefuelingFragment extends BaseFragment implements View.OnClickListener {
...
//    TextView payTypeSelectTv;
    ...
    public View initContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = UIUtils.inflate(R.layout.refurling_fg_layout);
    ...
    public void initView() {
        ...
        RelativeLayout chooseAddress = view.findViewById(R.id.refuel_deliver_chooseaddress_ll);
        chooseAddress.setOnClickListener(this);

//        LinearLayout chooseTime = view.findViewById(R.id.refuel_delivery_time);
//        chooseTime.setOnClickListener(this);
        addressTv = view.findViewById(R.id.refuel_delivery_address);
        addressName = view.findViewById(R.id.refuel_name);
        addressPhone = view.findViewById(R.id.refuel_user_phone);
        orderCommitBtn = view.findViewById(R.id.commit_order_btn);
        orderCommitBtn.setOnClickListener(this);
        RelativeLayout addCarRl = view.findViewById(R.id.add_car_rl);
        addCarRl.setOnClickListener(this);
        remarInfo = view.findViewById(R.id.remark_info);
//        Button addCarBtn = view.findViewById(R.id.refuel_delivery_add_car);
//        addCarBtn.setOnClickListener(this);

        addedCarLv = view.findViewById(R.id.added_car_lv);
        ...
        adressRl = view.findViewById(R.id.address_rl);

        allPriceMoney = view.findViewById(R.id.all_price_money);
//        deliverWay = view.findViewById(R.id.deliver_way);

        ticketType = view.findViewById(R.id.ticket_type);
...
//        }
        ...
        oilItemAdapter = new AddOilItemAdapter(getContext(), addedCarLv, oilsBeen);
...
//            此处 显示 发票 类型 在 界面上.....
    ...
    public void showDialog(String msg) {
        ...
        DialogUtils.showAlert(getActivity(), "提示", msg, "", "", "我知道了", "", true, new DialogUIListener() {
            @Override
            public void onPositive() {
